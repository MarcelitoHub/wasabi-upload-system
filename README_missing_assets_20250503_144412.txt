...
FILES INCLUDED:
1. missing_assets_for_ftp_20250503_144412.csv - List of missing assets to download from SFTP
2. create_folders_for_missing_20250503_144412.sh - Script to create the folder structure for downloads

STEPS TO COMPLETE:
1. Run the folder creation script to prepare your local structure:
   bash create_folders_for_missing_20250503_144412.sh
