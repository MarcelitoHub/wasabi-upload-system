...
This package contains information about 59,436 assets that are in the original list but not yet uploaded to Wasabi.

FILES INCLUDED:
1. missing_assets_for_ftp_20250502_102607.csv - List of missing assets to download from SFTP
2. create_folders_for_missing_20250502_102607.sh - Script to create the folder structure for downloads

STEPS TO COMPLETE:
1. Run the folder creation script to prepare your local structure:
   bash create_folders_for_missing_20250502_102607.sh
